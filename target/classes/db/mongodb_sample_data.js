// MongoDB Sample Data Script - Lab Compatible Format
// Run this script in MongoDB CLI after switching to cms_documents database

use cms_documents;

// Insert prescription documents matching lab format
db.prescriptions.insertMany([
  {
    ...
    "_class": "com.smartclinic.model.Prescription"
  },
  {
...
print("Inserted " + db.prescriptions.count() + " prescription documents");
